...
class JwtUtil(
    ...
    private fun getSecretKeyFromToken(token: String): SecretKey {
        ...
        return  getSecretKey(claims["email"] as String )
    }
    ...
    private fun getSecretKey(username:String): SecretKey {
        val secretKey = userSecretKeys[username] ?: defaultSecretKey
